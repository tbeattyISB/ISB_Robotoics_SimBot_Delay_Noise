...
# Try changing the amount of NOISE to see  how it affects your controller's ability to function normally
...
# In a comment below discuss how NOISE impacts a controller (a P-controller and a tuned PID-controller)
